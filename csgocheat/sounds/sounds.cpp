...
{//!memory::get_module_handle(fnv1a("serverbrowser.dll")) //why the fuck use this shit?
	...
	//		__(" "),
	//		__("https://eu.radiocastvps.com/radio/8010/radio.mp3?1560700863"),
	//		__("http://144.217.203.184:8972/listen.pls?sid=1&t=.m3u"),
	...
	//		__("http://listen.hardbase.fm/aac-hd.pls"),							// hardstyle
	//		__("http://uk5.internet-radio.com:8100/live")						// radio nla (rap / hip hop)
	//	};
	//
